...
assert.match(htmlSource, /styles\.css\?v=20260808-06/, "La hoja de estilos debe invalidar la cach̩ al publicar cambios del panel");
assert.match(htmlSource, /app\.js\?v=20260808-06/, "El script debe invalidar la cach̩ al publicar cambios del panel");
