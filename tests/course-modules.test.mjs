...
assert.match(htmlSource, /styles\.css\?v=20260810-03/, "La hoja de estilos debe invalidar la cach̩ al publicar cambios del panel");
assert.match(htmlSource, /app\.js\?v=20260810-03/, "El script debe invalidar la cach̩ al publicar cambios del panel");
