...
assert.doesNotMatch(appSource, /student-preview|Vista del alumno|renderTeacherStudentPreview/, "La vista del alumno debe estar eliminada del panel docente");
...
assert.match(htmlSource, /styles\.css\?v=20260825-01/, "La hoja de estilos debe invalidar la cach̩ al publicar cambios del panel");
assert.match(htmlSource, /app\.js\?v=20260825-01/, "El script debe invalidar la cach̩ al publicar cambios del panel");
