-- =========================================================
-- PERMITE AL ADMINISTRADOR GESTIONAR ESTADOS DE PROFESORES
-- =========================================================

-- La función public.is_admin() ya fue creada en una migración anterior.
...
-- Garantiza que los estados permitidos sean consistentes.
